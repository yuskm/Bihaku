...
$(function(){
	setTimeout(function(){
		$("body").stop().removeClass('fullscreen');
	},1000);
	...
	//	.focus(function(){
	//		$(this).attr("rows", "3");
	//		$button = $("#viewer .slide .caption .button");
	//		$button.show();
	//	})
	//	.blur(function(){
	//		if( $(this).val() == "" ){
	//			$(this).attr("rows", "1");
	//		}
	//		$("#viewer .slide .caption .button").hide();
	//	});
	$('#recommend')
		.focus(function(){
	...
	//$('body:not(#viewer .slide .caption > *)').click(function() {
	$('#main, .social, #map').click(function() {
		$('#caption').blur();
	});
